...
@section('title', 'Property | Add Property')
...
@section('main')
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 px-4 font-weight-bold" style="color: #45a9ea;">Buat Property</h1>
            <ol class="breadcrumb bg-light px-3 py-2 rounded shadow-sm">
                <li class="breadcrumb-item text-secondary">Property</li>
                <li class="breadcrumb-item text-secondary">Data Property</li>
                <li class="breadcrumb-item text-secondary">Buat Property</li>
            </ol>
        </div>

        <a class="btn btn-primary mb-3" href="{{ route('property') }}"
